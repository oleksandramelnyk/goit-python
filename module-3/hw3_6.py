'''Создайте функцию  format_string для форматирования строки. В функцию мы передаем строку string и length длину новой строки. 
...
def format_string(string, length):
    ...
    if len(string) >= length:
        ...
        times = (length - len(string)) // 2
        message = ' '
        return message * times + string
