...
Мы потренируемся решать подобные задачи. Разобьем ее на три этапа.
Первый этап — создайте функцию get_random_password, которая будет генерировать случайную строку пароль.
...
Таким образом функция get_random_password должна случайным образом выбрать из предложенного
диапазона 8 символов и возвратить сгенерированный пароль в виде строки.
"""
